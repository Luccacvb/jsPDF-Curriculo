...
export function addIntroductionPage(doc) {
	...
	addSection(
		...
		'Desenvolvedor Front-end e Mobile com experiência em JavaScript, TypeScript, React e React Native, em busca de oportunidades para evolução técnica e melhorias financeiras. Motivação por desafios que promovam o crescimento em desenvolvimento de software e inteligência artificial. Interessado em contribuir para projetos inovadores e colaborativos. Entre os objetivos pessoais estão viajar mais, conhecer novas culturas e evoluir no esporte que pratico, paraquedismo',
	)
	...
	addSection(doc, 255, 'Interesses Pessoais', 'Paraquedismo, surf, viagens, exploração cultural')
